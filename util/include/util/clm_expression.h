...
typedef enum ClmArithOp { ARITH_OP_ADD , ARITH_OP_SUB , ARITH_OP_MULT , ARITH_OP_DIV } ClmArithOp;
typedef enum ClmBoolOp { BOOL_OP_AND , BOOL_OP_OR , BOOL_OP_EQ , BOOL_OP_NEQ , BOOL_OP_GT , BOOL_OP_LT , BOOL_OP_GTE , BOOL_OP_LTE } ClmBoolOp;
typedef enum ClmUnaryOp { UNARY_OP_MINUS, UNARY_OP_TRANSPOSE , UNARY_OP_NOT } ClmUnaryOp;
